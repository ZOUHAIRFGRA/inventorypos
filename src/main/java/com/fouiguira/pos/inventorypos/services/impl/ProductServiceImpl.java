...
public class ProductServiceImpl implements ProductService {
    ...
    @Autowired
    private CategoryService categoryService; // Inject CategoryService to fetch categories
    ...
    public List<Product> getProductsByCategory(String categoryName) {
        Category category = categoryService.getCategoryByName(categoryName); // Fetch Category object
        if (category == null) {
            return List.of(); // Return an empty list if category is not found
        }
        return productRepository.findByCategory(category); // Use Category object
    }
    ...
    public Product updateProduct(Long id, Product product) {
        ...
        if (existingProduct != null) {
            ...
            existingProduct.setCategory(product.getCategory()); // Assign the Category object
